...
const Nav = ({ onSearchClick, bookmarkCount }) => {
            ...
            <div className={`navbuttons ${isMenuOpen ? "open" : ""}`}>
                <ul>
                    ...
                    <div className="bookmarknav">
                        <div> <li onClick={closeMenu}>Bookmarks</li></div>
                        <div className="notification">{bookmarkCount}</div>
                    </div>
